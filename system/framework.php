...
if ($config->get('db_autostart')) {
	...
	$registry->set('newdb', new DB('mysqli', NEWDB_HOSTNAME, NEWDB_USERNAME, NEWDB_PASSWORD, NEWDB_DATABASE, NEWDB_PORT));
}
...
if ($config->has('action_pre_action')) {
	//echo '<pre>';print_r($config->get('action_pre_action'));
	//exit('inside action_pre_action'.$config->has('action_pre_action'));
...
//exit("value of ".$config->get('action_router'));
$response->output();