...
class ControllerReportsTrpod extends Controller {

    private $error = array();
    public $viewPathPrefix='reports/trpod';	
	...
	$data['header'] = $this->load->controller('common/header');
        ...
        $trucksQry=$this->model_settings_transporter->getItems($filter_data);
        foreach($trucksQry->rows as $row){
            $data['transporters'][$row['id_transporter']]=$row;
        }
    ...
    public function getlist() {
        ...
        $filter_trbillraised=isset($this->request->get['filter_trbillraised'])?$this->request->get['filter_trbillraised']:'';
	...
	//$filter_materialcode=isset($this->request->get['filter_materialcode'])?$this->request->get['filter_materialcode']:'';
        ...
        $urlData['filter_trbillraised']=$filter_trbillraised;
        ...
        $filter_data = array(
            'filter_trbillraised' => $filter_trbillraised,
            'filter_id_truck' => $filter_id_truck,
            'filter_loadprovider' => 'TR',
    ...
    public function download(){
        ...
        $truckObj=$this->model_excel->downloadTrpodReport($results->rows);
        exit;
    }
 }