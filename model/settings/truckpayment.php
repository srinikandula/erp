<?php
class ModelSettingsTruckpayment extends Model {
	public $mTable;
	public $pKey;

	public function __construct($className=__CLASS__){
		$this->mTable=DB_PREFIX.'truck_payment';
		$this->pKey='id_truck_payment';
	...
	public function getItem($id) {
		...
		$sql = "SELECT b.branchcode,b.branchcity,b.isheadoffice,trp.*,tr.contactname,tr.contactmobile,tr.truckno FROM `" . $this->mTable . "` trp left join ".DB_PREFIX."truck tr on trp.id_truck=tr.id_truck left join ".DB_PREFIX."branch b on trp.id_branch=b.id_branch where  trp.".$this->pKey."='" . (int)$id . "'";
		//echo $sql;
	...
	public function getItems($data = array()) {
		...
		$sql = "SELECT b.branchcode,b.branchcity,b.isheadoffice,trp.*,tr.contactname,tr.contactmobile,tr.truckno FROM `" . $this->mTable . "` trp left join ".DB_PREFIX."truck tr on trp.id_truck=tr.id_truck left join ".DB_PREFIX."branch b on trp.id_branch=b.id_branch where  trp.".$this->pKey."!=0";
