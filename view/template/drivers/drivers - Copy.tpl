        ...
        if (flag) {
            ...
            $.ajax({
                ...
                success: function(json) {
                    ...
                    //alert('in success');
                    if (json['status']) {
                        $('#list_drivercode_' + type).html($('#field_drivercode').val());
                        $('#list_drivername_' + type).html($('#field_drivername').val());
			$('#list_drivermobile_' + type).html($('#field_drivermobile').val());
			$('#list_doj_' + type).html($('#field_doj').val());
			$('#list_alternateno_' + type).html($('#field_licenceno').val());
			$('#list_licencevalidtilldate_' + type).html($('#field_licencevalidtilldate').val());
			$('#list_fixedpermonth_' + type).html($('#field_fixedpermonth').val());
			$('#list_batta_' + type).html($('#field_batta').val());
			$('#list_pertrippercentonfreight_' + type).html($('#field_pertrippercentonfreight').val());
			$('#list_pertripcommission_' + type).html($('#field_pertripcommission').val());
			$('#list_status_' + type).html($('#field_status').val());
                        //$('#page-wrapper').before(getFlashWrapper('success',json['msg']));                 

                        //reset form
                        $('#field_drivercode').val("");
                        $('#field_drivername').val("");
			$('#field_drivermobile').val("");
			$('#field_doj').val("");
			$('#field_alternateno').val("");
			$('#field_licencevalidtilldate').val("");
			$('#field_fixedpermonth').val("");
			$('#field_batta').val("");
			$('#field_pertrippercentonfreight').val("");
			$('#field_pertripcommission').val("");
			$('#field_status').val("");
