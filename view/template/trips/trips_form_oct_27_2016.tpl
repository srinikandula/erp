...
<?php foreach(getPaymentMode() as $k=>$v){ echo '<option value="'.$k.'">'.$v.'</option>'; }?>
				...
				?>
                    ...
                    <fieldset class="large-form-fieldset" id="field_transit_details">
                            ...
                            <?php
                            getInputText(array("col"=>"omr","title"=>"Open Meter Reading","required"=>0,"mainDivClass"=>"form-group col-md-6","labelClass"=>"col-md-6","divClass"=>"col-md-6"));
                            getInputText(array("col"=>"cmr","title"=>"Closed Meter Reading","required"=>0,"mainDivClass"=>"form-group col-md-6","labelClass"=>"col-md-6","divClass"=>"col-md-6"));
                            ?>
