                    ...
                    <div class="col-md-9" id="idGridContainer">
                        <table class="mtable table table-striped table-bordered table-responsive table-condensed table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:50%">
                                        <?php if($sort=='material'){ 
                                        echo '<a href="'.$sort_material.'">Material <i class="fa fa-sort-'.strtolower($order).'" aria-hidden="true"></i></a>';
                                        }else{
                                            echo '<a href="'.$sort_material.'">Material</a>';
                                        }?>
                                        
                                    </th>
                                    <th style="width:40%">
                                        <?php if($sort=='materialcode'){ 
                                        echo '<a href="'.$sort_materialcode.'">Material Code <i class="fa fa-sort-'.strtolower($order).'" aria-hidden="true"></i></a>';
                                        }else{
                                            echo '<a href="'.$sort_materialcode.'">Material Code</a>';
                                        }?>
                                    </th>
                                    <th style="width:3%"></th>
                                    <!--<th style="width:3%"></th>-->
                            ...
                            <tbody>
                                <!--<tr id="list_filter">
                                    <td></td>
                                    <td></td>
                                    <td><div><input type="text" name="vehModel"></div></td>
                                ...
                                <tr id="list_<?php echo $item['id_material'];?>">
                                    <td><?php if (in_array($item['id_material'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $item['id_material']; ?>" checked="checked" />
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $item['id_material']; ?>" />
                                    <?php } ?></td>
                                    <td><?php echo $k+1;?></td>
                                    <td id="list_material_<?php echo $item['id_material'];?>"><?php echo $item['material'];?></td>
                                    <td id="list_materialcode_<?php echo $item['id_material'];?>"><?php echo $item['materialcode'];?><?php //echo json_encode($item); ?></td>
                                    <td><i class="fa fa-fw fa-edit <?php echo $editPermClass;?>" onclick='fnEdit(<?php echo json_encode($item); ?>);'></i> </td>
                                    <!--<td><i class="fa fa-trash-o fa-lg <?php echo $deletePermClass;?>"></i> </td>-->
                                </tr>
                                <?php } ?>
                                <?php } else { ?>
                                <tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                <div class="center-div"><?php echo $results; ?></div>
