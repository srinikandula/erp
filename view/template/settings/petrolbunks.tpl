...
<div id="page-wrapper">
    ...
    <div class="row" >
        ...
        <?php include '_petrolbunks_form.tpl';?>
        <!-- /.row -->
    </div>
...
<script>
    function fnSubmit(btn) {
        ...
        if ($('#field_fuelstationcode').val() == "") {
            //alert("inside");
            $('#field_fuelstationcode').closest('.col-md-8').addClass('has-error');
            var flag = 0;
        } else {
            $('#field_fuelstationcode').closest('.col-md-8').removeClass('has-error');
        }

        if ($('#field_fuelstationname').val() == "") {
            //alert("inside");
            $('#field_fuelstationname').closest('.col-md-8').addClass('has-error');
            var flag = 0;
        } else {
            $('#field_fuelstationname').closest('.col-md-8').removeClass('has-error');
        }

	 if ($('#field_fuelpersonname').val() == "") {
            //alert("inside");
            $('#field_fuelpersonname').closest('.col-md-8').addClass('has-error');
            var flag = 0;
        } else {
            $('#field_fuelpersonname').closest('.col-md-8').removeClass('has-error');
        }

	if ($('#field_fuelpersonmobile').val() == "") {
            //alert("inside");
            $('#field_fuelpersonmobile').closest('.col-md-8').addClass('has-error');
            var flag = 0;
        } else {
            $('#field_fuelpersonmobile').closest('.col-md-8').removeClass('has-error');
        }
