<div id="myModal" class="modal fade" role="dialog">
    ...
    <table class="table table-responsive table-bordered table-condensed table-striped" id="factory_rates_table">
		...
		<td><input name="field[wait_charges]" class="form-control" placeholder="Wait Charges" title="Wait Charges" id="field_wait_charges" type="text"></td>

		<td><input name="field[ext_unload_charges]" class="form-control" placeholder="Ext Unloading Charges" title="Ext Unloading Charges" id="field_ext_unload_charges" type="text"></td>
                
		<td><input name="field[incentives]" class="form-control" placeholder="Incentives" data-toggle="tooltip" data-placement="auto top" title="Incentives" id="field_incentives" type="text" value="0"></td>
...
<script>
    ...
    $("#field_freight, #field_tds, #field_vat, #field_toll, #field_loading, #field_unloading, #field_advance,  #field_shortage, #field_damage, #field_damage, #field_incentives").on('keyup',function(){
	...
	var incentives=parseFloat($("#field_incentives").val()) || 0;
	...
	var netamount=0;
        netamount=parseFloat((totalfreight+incentives)-(totalshortage+totaldamage+totaladvance)+(totalloading+totalunloading+totaltoll+wait_charges+ext_unload_charges)+(vatamount+tdsamount)) || 0;
