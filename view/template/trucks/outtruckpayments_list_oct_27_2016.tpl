...
$("input[type='checkbox']").on("click",function(){
	...
	$('input:checked').each(function() {
		...
		amount+=(parseFloat(jsn['truckrate'])*parseFloat(jsn['qty']))-(parseFloat(jsn['driveradvance'])+parseFloat(jsn['shortage'])+parseFloat(jsn['damage'])+parseFloat(jsn['loadingexp'])+parseFloat(jsn['unloadingexp']));
	});
        //alert(amount)
