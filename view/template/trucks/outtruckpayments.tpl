		...
		success: function(json) {
			...
			if (json['status']) {
				...
				$.each(json['trip'],function(key,data){
					...
					trip_td+="<tr><td>"+data['id_trip']+"</td><td>"+data['operatingroutecode']+"</td><td>"+data['transactiondate']+"</td><td>"+data['dispatchdate']+"</td><td>"+freight+"</td><td>"+data['shortage']+"</td><td>"+data['damage']+"</td><td>"+data['loadingexp']+"</td><td>"+data['unloadingexp']+"</td><td>"+data['wait_charges']+"</td><td>"+data['ext_unload_charges']+"</td><td>"+data['driveradvance']+"</td><td>"+podamount+"</td></tr>";
				} );
