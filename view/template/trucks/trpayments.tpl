...
<div id="page-wrapper">
    <div class="row">
        <div class="col-md-12">
            <?php include 'trpayments_search.tpl';?>
            <div class="row">
...
function fnTrPayment(id){
	...
	$.ajax({
		...
		success: function(json) {
			...
			//alert('in success');
			if (json['status']) {
				$('#truck_payment_table tbody').html("<tr><td>"+json['truck']['id_transporter_payment']+"</td><td>"+json['truck']['transportercontactperson']+"/"+json['truck']['transportercontactmobile']+"</td><td>"+json['truck']['nooftrips']+"</td><td>"+json['truck']['datereceived']+"</td><td>"+paymentMode[json['truck']['paymentmode']]+"</td><td>"+json['truck']['paymentref']+"</td><td>"+json['truck']['totalreceivableamount']+"</td><td>"+json['truck']['branchcity']+"</td></tr>");
				var trip_td; 
				$.each(json['trip'],function(key,data){
					//alert("key "+key);
					//alert("data "+data);
					var freight=data['truckrate']*data['qty'];
					var podamount=parseFloat(freight)-(parseFloat(data['shortage'])+parseFloat(data['damage'])+parseFloat(data['loadingexp'])+parseFloat(data['unloadingexp'])+parseFloat(data['transporteradvance']));
					//alert(freight+" "+podamount);
					//alert(data['shortage']+" "+data['damage']+" "+data['loadingexp']+" "+data['unloadingexp']+" "+data['driveradvance']);

					trip_td+="<tr><td>"+data['id_trip']+"</td><td>"+data['truckno']+"</td><td>"+data['operatingroutecode']+"</td><td>"+data['material']+"</td><td>"+data['transactiondate']+"</td><td>"+freight+"</td><td>"+data['shortage']+"</td><td>"+data['damage']+"</td><td>"+data['loadingexp']+"</td><td>"+data['unloadingexp']+"</td><td>"+data['transporteradvance']+"</td><td>"+podamount+"</td></tr>";
				} );
