	...
	<h4><?php echo $page['title']; ?> <span style="font-style:italic;font-size:10px;font-weight:bold">Add/Edit</span>
      ...
      <div class="modal-body col-md-12">
          <div id="form_right">
            ...
            <form id="horizontalForm" class="form-horizontal" method="post" enctype="multipart/form-data">
		...
		<div class="form-group col-md-6 required"  id="div_field_rc_file">
			<label for="accountID" class="col-md-4">Upload RC :</label>
			<div class="col-md-8">
				<input name="field_rc_file" class="form-control" placeholder="Upload RC" title="Upload RC" id="field_rc_file"  type="file">
				<input type="hidden" name="prev_rc_file" id="prev_rc_file"><span id="span_rc_file"></span>
			</div>
		</div>

		<div class="form-group col-md-6 required" id="div_field_pancard_file">
			<label for="accountID" class="col-md-4">Upload Pan Card :</label>
			<div class="col-md-8">
				<input name="field_pancard_file" class="form-control" placeholder="Upload Pan Card" title="Upload Pan Card" id="field_pancard_file"  type="file">
				<input type="hidden" name="prev_pancard_file" id="prev_pancard_file" ><span id="span_pancard_file"></span>
			</div>
		</div>
